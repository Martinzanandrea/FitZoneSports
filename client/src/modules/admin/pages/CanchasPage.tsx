...
import { Button, Chip, PageHeader, Pagination, StatCard } from '../../../shared/components/ui';
...
export function CanchasPage() {
  ...
  return <div className="max-w-6xl">
    ...
    <div className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-3">
      ...
      <StatCard label="Ingresos canchas (mes)" value="Próximamente" sub="Sin endpoint directo" icon={DollarSign} iconColor="#16A34A" />
    </div>
